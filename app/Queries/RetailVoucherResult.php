...
class RetailVoucherResult
{
    public static function query()
    {
        ...
        $query->when(request()->voucher , function ($query) {
            $query->where('order_posting.voucher_code', request()->voucher);
        });

        $query->whereNotNull('order_posting.voucher_code');
        $query->whereNull('orders.cancelled_date');
