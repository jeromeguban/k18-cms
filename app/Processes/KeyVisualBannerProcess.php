...
class KeyVisualBannerProcess
{
    ...
    */
    ...
    public function uploadImage()
    {
        ...
        $location = public_path('images/key_visuals'.date('/Y/m/').$this->filename);
        $location_path = public_path('images/key_visuals'.date('/Y/m/'));
    ...
    public function updateKeyVisualBanner()
    {
        ...
        $this->keyVisual->update([
            'banner'  => '/images/key_visuals'.date('/Y/m/').$this->filename
        ]);
    ...
    public function removeImageInPublicDirectory()
    {
        if($file = $this->keyVisual->refresh()->banner) {
            Storage::disk('key_visuals')->delete($file);
        }
