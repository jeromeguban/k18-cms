...
class EventRegistrationBannerProcess
{
	protected $file;
	protected $event;
	protected $filename;
    ...
    */
    ...
    {
    	if($this->request->image_name == $this->event->registration_banner)
            $this->event->update([
                'registration_banner' => null
            ]);
    ...
    public function updateEventRegistrationBanner()
    {
    	$this->event->update([
    		'registration_banner'	=> '/images/events'.date('/Y/m/').$this->filename
    	]);
