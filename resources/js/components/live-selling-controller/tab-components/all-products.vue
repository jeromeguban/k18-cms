...
<template>
    <div class="mb-4 lg:overflow-y-auto" style="max-height: 500px">
        <div class="flex justify-center p-4 bg-white border border-gray-200 rounded-lg cursor-pointer"  v-if="!all_products.length">
        ...
        <div class="py-2">
          <div class="products-box-shadow bg-white rounded-lg grid grid-cols-12 mb-2" v-for="product in all_products" :key="product.name" v-if="all_products && all_products.length">
