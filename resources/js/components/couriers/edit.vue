<template>
	<div ref="close" id="couriers-edit" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Edit Courier</h2>
...
export default {
	...
	created() {
		this.form = new Form(this.courier);
	},
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.patch(`/couriers/${this.courier.id}`)
				.then(() => {
					this.isLoading = false;
					this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
						setTimeout(() => resolve({
							title: 'Success!',
							body: 'Courier Successfuly Updated!',
							config: {
								timeout: 2000,
