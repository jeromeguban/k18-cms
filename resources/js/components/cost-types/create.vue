<template>
	<div>
		<div ref="close" id="cost-types-create" class="modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">

					<!-- BEGIN: Modal Header -->
					<div class="modal-header bg-primary-1 text-theme-2">
						<h2 class="font-medium text-base mr-auto">Create New Cost Type</h2>
...
export default {
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.post('/cost-types')
			.then(() => {
				 this.isLoading = false;
				 this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
					setTimeout(() => resolve({
						title: 'Success!',
						body: 'Cost Type successfully created!',
						config: {
						timeout: 2000,
