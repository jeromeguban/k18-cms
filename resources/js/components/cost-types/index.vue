<template>
	<div class="w-full">
		<table-template link="/cost-types" :fields="fields" modalIdentifier="#cost-types-create">
		<template slot="label">
			<h4>List of Cost Types</h4>
		</template>
	    ...
	    <template slot="id" slot-scope="props">
			...
			<a class="flex items-center mr-3" href="javascript:;" data-toggle="modal" data-target="#cost-types-edit"  @click.prevent="setCostType(props.item, props.index)" v-can="'update.cost-type'" >
