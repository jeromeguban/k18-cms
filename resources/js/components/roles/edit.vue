<template>
	<div ref="close" id="roles-edit" class="modal" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<form class="">
					<div class="modal-body p-10">
						...
						<edit-role-permission class="mt-8" :id="form.id"></edit-role-permission>
...
<script>
import EditRolePermission from '../role-permissions/edit';
export default {
	components: { EditRolePermission },
	props:['role'],
	data() {
		return {
			form: {},
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.patch(`/roles/${this.role.id}`)
			.then(() => {
				this.isLoading = false;
		     this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
				setTimeout(() => resolve({
					title: 'Success!',
					body: 'Role Successfuly Updated!',
					config: {
					timeout: 2000,
