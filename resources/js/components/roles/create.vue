<template>
	<div>
		<div ref="close" id="roles-create" class="modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">

					<!-- BEGIN: Modal Header -->
					<div class="modal-header bg-primary-1 text-theme-2">
						<h2 class="font-medium text-base mr-auto">Create New Roles</h2>
						...
						<div class="modal-body p-10">
							...
							<div class="input-form">
								...
								<label for="validation-form-2" class="form-label w-full flex flex-col sm:flex-row mt-3">
									Description <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600"
