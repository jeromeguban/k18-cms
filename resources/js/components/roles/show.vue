            ...
            <div class="flex gap-x-6">
                ...
                <div class="flex flex-col pb-3 gap-y-3 border-r border-gray-200">
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Role Name</div>
                        <div class="w-96 pr-3">{{ role.name }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Role Description</div>
                        <div class="w-96 pr-3">{{ role.description }}</div>
                    </div>
                </div>
                <!-- 2nd column example -->
				<!-- <div class="flex flex-col pb-3 gap-y-3">
					<div class="flex leading-loose">
                        ...
                        <div class="w-96 pr-3">{{ email.fullname }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Created Date</div>
                        <div class="w-96 pr-3">{{ email.created_at }}</div>
                    </div>
					<div class="flex leading-loose">
					...
					<div class="flex leading-loose">
                        ...
                        <div class="w-96 pr-3">{{ email.updated_at }}</div>
                    </div>
				</div> -->
            </div>
        </span>
    </div>
	<role-permissions v-if="role.id" :id="role.id" v-can="'list.permission'"></role-permissions>
</div>
