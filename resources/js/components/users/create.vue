<template>
	...
	<div ref="close" id="users-create" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Create New Users</h2>
				...
				<form class="">
					<div class="modal-body p-10">
						...
						<div class="input-form">
							...
							<input v-model="form.phone" type="number" name="phone" class="form-control" placeholder="">
							...
							<input v-model="form.password" type="password" name="phone" class="form-control"
								placeholder="">


							<label class="form-label w-full flex flex-col sm:flex-row mt-3">
								Password confirmation <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-theme-6 "
									v-if="form.errors.get('password_confirmation')"
							...
							<multiselect :multiple="true" v-model="form.stores" :options="stores" :custom-label="storeCustomLabel"
								name="stores" customMaxWidth="100%"></multiselect>
