<template>
	<div ref="close" id="modules-create" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Create New Modules</h2>
					...
					<div class="modal-body p-10">
						...
						<div class="input-form">
							...
							<input v-model="type" type="text" name="description" class="form-control"
								placeholder="Permission Type" v-on:keyup.13="addPermission()">
						</div>
...
export default {
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.post('/modules')
			.then(() => {
				this.isLoading = false;
		        this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
					setTimeout(() => resolve({
						title: 'Success!',
						body: 'Module successfully created!',
						config: {
						timeout: 2000,
		...
		addPermission() {
			...
			this.form.module_permissions.push(this.type);
			this.type = "";
    	},
