...
<div>
	<div class="intro-y box p-5 mt-5">
        ...
        <div class="text-lg text-black font-semibold leading-loose">Show Details - Affiliate</div>
        <p class="text-gray-700 leading-loose border-b border-gray-200 pb-2 mb-4">This page contains information about your Affiliate details</p>
            ...
            <div class="flex gap-x-6">
                ...
                <div class="flex flex-col pb-3 gap-y-3 border-r border-gray-200">
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Code</div>
                        <div class="w-96 pr-3">{{ affiliate.code }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">First name</div>
                        <div class="w-96 pr-3">{{ affiliate.first_name }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Middle name</div>
                        <div class="w-96 pr-3">{{ affiliate.middle_name }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Last Name</div>
                        <div class="w-96 pr-3">{{ affiliate.last_name }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Email</div>
                        <div class="w-96 pr-3">{{ affiliate.email }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Phone Number</div>
                        <div class="w-96 pr-3">{{ affiliate.phone_no }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Commission</div>
                        <div class="w-96 pr-3">{{ affiliate.commission }}</div>
                    </div>
                </div>
                <!-- 2nd column example -->
...
<script>
import Record from './affiliate-record'
	export default {	
        components: {
			Record,
		},
		...
		methods: {
			show() {
				   axios.get('/affiliate-marketing/' + this.$route.params.id, {
				   	params: {
