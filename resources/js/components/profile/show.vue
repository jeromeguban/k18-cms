<template>
	<div class="w-full">
		<table-template :link="'/user/'+profile+'/activity-logs'" :fields="fields" :addNewBtn = "false" :params="params">
			<template slot="label">
				<h4>Activity Logs</h4>
			</template>
		    ...
		    <template slot="id" slot-scope="props">
		    	<router-link class="btn btn-link mr-2" :to="'user/activity-logs/' + props.item.id">
