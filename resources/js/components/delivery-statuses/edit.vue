<template>
	<div ref="close" id="delivery-statuses-edit" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Edit Delivery Status</h2>
...
export default {
	...
	created() {
		this.form = new Form(this.delivery_status);
	},
	watch:{
        'delivery_status' () {
        this.form = new Form(this.delivery_status);
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.patch(`/delivery-statuses/${this.delivery_status.id}`)
			.then(() => {
				this.isLoading = false;
		     	this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
				setTimeout(() => resolve({
					title: 'Success!',
					body: 'Delivery Statuses Successfuly Updated!',
					config: {
					timeout: 2000,
