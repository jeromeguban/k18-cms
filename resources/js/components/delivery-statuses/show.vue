					...
					<tbody>
						<tr>
							<td class="border-b dark:border-dark-5">
								<div class="font-medium whitespace-nowrap">Code</div>
							</td>
							<td class="text-right border-b dark:border-dark-5 w-32 font-medium">{{ delivery_status.code }}</td>
						</tr>
						<tr>
							<td class="border-b dark:border-dark-5">
								<div class="font-medium whitespace-nowrap"> Description</div>
							</td>
							<td class="text-right border-b dark:border-dark-5 w-32 font-medium">{{ delivery_status.description }}</td>
						</tr>
					</tbody>
				</table>
			</div>
...
<script>
	export default {
		...
		methods: {
			show() {
				   axios.get('/delivery-statuses/' + this.$route.params.id)
			        .then((response) => {
