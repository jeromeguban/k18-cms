<template>
	<div>
		<div ref="close" id="inquire_emails-create" class="modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">

					<!-- BEGIN: Modal Header -->
					<div class="modal-header bg-primary-1 text-theme-2">
						<h2 class="font-medium text-base mr-auto">Create Contact Us Email Settings</h2>
						...
						<div class="modal-body p-10">
							...
							<div class="input-form">
								...
								<span class="text-red-500 my-2 flex items-center text-2xs"
									v-if="form.errors.has('emails')" v-text="form.errors.get('emails')" />
...
export default {
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.post('/inquire-emails')
			.then(() => {
				 this.isLoading = false;
				 this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
					setTimeout(() => resolve({
						title: 'Success!',
						body: 'Tag successfully created!',
						config: {
						timeout: 2000,
