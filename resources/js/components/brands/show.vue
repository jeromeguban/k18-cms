            ...
            <div class="flex gap-x-6">
                ...
                <div class="flex flex-col pb-3 gap-y-3 border-r border-gray-200">
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Brand Code</div>
                        <div class="w-96 pr-3">{{ brand.brand_code }}</div>
                    </div>
                    <div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Brand Name</div>
                        <div class="w-96 pr-3">{{ brand.brand_code }}</div>
                    </div>
                </div>
                <!-- 2nd column example -->
...
<script>
	export default {
		...
		methods: {
			show() {
				   axios.get('/brands/' + this.$route.params.id)
			        .then((response) => {
