<template>
	<div class="w-full">
		<table-template :link="'/events/'+event.event_id+'/activity-logs'" :fields="fields" :addNewBtn="false">
        ...
        <template slot="id" slot-scope="props">
            <router-link class="btn btn-link mr-2" :to="'/event-activity-logs/' + props.item.id" v-can="'view.event'">
