            ...
            <div class="flex gap-x-6">
                ...
                <div class="flex flex-col pb-3 gap-y-3 border-r border-gray-200">
                    <div class="flex leading-loose">
                        ...
                        <div class="w-96 pr-3">{{ term.name }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Type</div>
                        <div class="w-96 pr-3">{{ term.type }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Terms</div>
                        <div class="w-96 pr-3" v-html="term.terms"></div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Created By</div>
                        <div class="w-96 pr-3">{{ term.created_by.fullname }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Created Date</div>
                        <div class="w-96 pr-3">{{ term.created_at }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Modified By</div>
                        <div class="w-96 pr-3">{{ term.modified_by.fullname }}</div>
                    </div>
					<div class="flex leading-loose">
                        <div class="w-52 font-semibold pr-3">Modified Date</div>
                        <div class="w-96 pr-3">{{ term.updated_at }}</div>
                    </div>
                </div>
                <!-- 2nd column example -->
...
<script>
	export default {	
		...
		methods: {
			show() {
				   axios.get('/terms/' + this.$route.params.id, {
				   	params: {
