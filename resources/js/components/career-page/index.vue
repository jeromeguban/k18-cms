<template>
    <div class="w-full">
        <table-template
            ...
            modalIdentifier="#careers-create"
        >
            <template slot="label">
            ...
            <template slot="id" slot-scope="props">
                <div class="flex items-center">
                    ...
                    <a
                        ...
                        href="javascript:;"
                        data-toggle="modal"
                        data-target="#careers-edit"
                        @click.prevent="setCareer(props.item, props.index)"
                        v-can="'update.career'"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a
                        class="flex items-center mr-3 mt-1"
                        href="javascript:;"
                        @click.prevent="deleteCareer(props.item.career_id)"
                        v-can="'delete.career'"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
        ...
        <edit v-if="career" :career="career" />

        <banner v-if="career" :career="career" />
    </div>
</template>
...
export default {
    components: { TableTemplate, Create, Edit, Banner },
    ...
    data() {
        return {
            fields: {
                ...
                job_specialization: "Specialtzation",
                job_role: "Role",
            },
