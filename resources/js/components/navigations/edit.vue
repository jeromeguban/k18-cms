...
<template>
	<div ref="close" id="navigation-edit" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Edit Navigation</h2>
								...
								<div class="sm:mt-6 mt-0">
									<draggable v-model="form.properties"
										...
										<div class="border mb-4 border-gray-300 border-solid shadow-md rounded w-full "
											v-for="(properties, index) in form.properties">
											<div class="flex relative">
												...
												<div class="w-full ml-4">
													<vfa-picker v-model="properties.icon">
														<template v-slot:activator="{ on }">
															<input v-model="properties.icon" @click="on" type="text"
																name="icon"
																class="border border-solid border-gray-300 focus:border-indigo-300 px-2 py-2 rounded outline-none flex-0 h-10 mt-2 w-full"
																placeholder="Icon">
														</template>
