...
<template>
	<div ref="close" id="footer-edit" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Edit Footer</h2>
						...
						<div class="input-form">
							...
							<!-- <div class="flex w-1/2 mt-4">
								<a href="" @click.prevent="addRow()"
									class="btn btn-primary btn-primary-shadow mt-4 md:mt-0 ">
