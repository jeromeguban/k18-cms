<template>
	<div>
		<div ref="close" id="stores-create" class="modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">

					<!-- BEGIN: Modal Header -->
					<div class="modal-header bg-primary-1 text-theme-2">
						<h2 class="font-medium text-base mr-auto">Create New Store</h2>
					...
					<form class="">
						<div class="modal-body p-10">
							...
							<div class="input-form">
								...
								<multiselect v-model="company" :options="companies" label="company_name"
									name="companies" customMaxWidth="100%"></multiselect>
								...
								<label for="validation-form-2" class="form-label w-full flex flex-col sm:flex-row mt-3">
									Address Line <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-theme-6"
										v-if="form.errors.get('address_line')"
										v-html="form.errors.get('address_line')" />
								</label>
								...
								<label class="form-label w-full flex flex-col sm:flex-row mt-3">Store
									Description</label>
								...
								<input v-model="form.email" type="text" name="email" class="form-control"
									placeholder="">
								<label class="form-label w-full flex flex-col sm:flex-row mt-3">Store Company
									Code</label>
								...
								<label class="form-label w-full flex flex-col sm:flex-row mt-3">Store Type</label>
								<div class="col-sm-10">
									<select
										class="border border-solid border-gray-300 focus:border-indigo-300 px-2 py-2 rounded outline-none w-full flex-0 h-10 mt-1"
									...
									<span class="text-red-500 mt-2 flex items-center text-2xs mb-4"
										v-if="form.errors.has('store_type')"
										v-text="form.errors.get('store_type')"></span>
								</div>
							</div>
							...
							<div class="col-sm-10">
								<multiselect :multiple="true" v-model="courier" :options="couriers" label="name"
