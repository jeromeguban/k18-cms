...
<div class="intro-y w-full h-full mb-2">
		<div class="flex flex-col mt-6 lg:flex-row">
				...
				<span class="text-center mb-4 py-2 uppercase text-white bg-theme-1 italic">Customer Login Credential Import</span>
				<div>
	...
	export default {
		...
		methods: {
			upload(event) {
				...
				this.loading = true;
				this.form.post('/customer-login-credential/upload')
				.then(response => {
