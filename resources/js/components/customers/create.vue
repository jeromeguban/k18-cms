<template>
	<div ref="close" id="customers-create" class="modal" tabindex="-1" aria-hidden="true">
				...
				<form class="">
					<div class="modal-body p-10 overflow-auto  sideform-container--height">
						<div class="input-form">
							...
							<div v-show="form.login_credential">
								<div>
									<label class="form-label w-full flex flex-col sm:flex-row">
										User Name
										<span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-theme-6 "
...
export default {
	...
	methods: {
		submit() {
			...
			.then(() => {
				 ...
				 this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
					setTimeout(() => resolve({
						title: 'Success!',
						body: 'Customer Successfuly Created!',
						config: {
						timeout: 2000,
		...
		changeLoginCredential(){
			this.form.login_credential = !this.form.login_credential;
		},
