<template>
	<div ref="close" id="quicklink-create" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Create New Quicklink</h2>
				...
				<form class="" @keydown.enter.prevent="" @submit.prevent="store">
					<div class="modal-body p-10">
						<div class="input-form">
							<input-file id="icon" class="mt-4" label="Icon" name="icon" :multiple="false"
								v-model="form.icon"
								:errorMessage="form.errors.has('icon') ? form.errors.get('icon') : ''"
		...
		store() {
			...
			.then(()=>{
				 ...
				 this.$snotify.async('Please wait', 'Processing...', () => new Promise((resolve, reject) => {
					setTimeout(() => resolve({
						title: 'Success!',
						body: 'Quicklink successfully created!',
						config: {
						timeout: 2000,
