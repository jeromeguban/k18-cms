<template>
	<div>
		<div ref="close" id="event-access-request-templates-create" class="modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">
					<!-- BEGIN: Modal Header -->
					<div class="modal-header bg-primary-1 text-theme-2">
						<h2 class="font-medium text-base mr-auto">Create New Event Email Template</h2>
					</div>
					<form class="">
						<div class="modal-body p-10">
							<div class="input-form">
								...
								<vue-editor v-model="form.body" class="mt-2"></vue-editor>
...
export default {
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.post('/event-access-request-templates')
			.then(() => {
