<template>
	<div ref="close" id="tags-logo" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">

				<!-- BEGIN: Modal Header -->
				<div class="modal-header bg-primary-1 text-theme-2">
					<h2 class="font-medium text-base mr-auto">Set Logo</h2>
...
export default {
	...
	methods: {
		submit() {
			this.isLoading = true;
			this.form.post(`/tags/${this.tags.id}/logo`)
				.then(() => {
					this.isLoading = false;
