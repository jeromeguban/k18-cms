	...
	<div class="email" style="border: 1px solid #ddd; padding: 20px; border-top:5px solid #fd7936; border-bottom:5px solid #fd7936">
		<div class="email-header">
				<div class="logo-container">
					...
					<p class="address" style="font-size: 14px; clear: both; margin-top: 10px;">{{ $event['event_name'] }}</p>
				</div>
				<span class="email-type" style="text-transform: uppercase; text-decoration: underline;">Access Declined</span>
			...
			<div class="email-body">
				...
				<!-- Your registration to join the private bidding has not been approved due or may of the following criteria;<br> -->

				<br><p>{!! $template['body'] !!}</p><br>

				<!-- For further assistance please call our Customer Service at <a href="" style="color:#003663; font-weight: 800; text-decoration: underline;">09084560948 / 09175483603</a> -->
				Thank you! <br>
