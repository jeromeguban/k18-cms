...
<body>
    <div class="email" style="border: 1px solid #ddd; padding: 20px; border-top:5px solid #fd7936; border-bottom:5px solid #fd7936">
        <div class="email-header">
            ...
            <center>
                <span class="email-type" style="text-transform: uppercase; text-decoration: underline;">You have been Assigned for this Inquiry</span>
            </center>
        ...
        <div class="email-body">
            ...
            <br>
            <a  href="https://cms.hmr.ph/dashboard#/account-executive/dashboard?tag=inquiries&page=1">
                Go To My CMS Dashboard
            </a>
